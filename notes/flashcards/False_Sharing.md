...
?
- V1 (mutex): serialized, highest latency.
- V2 (single shared atomic): removes mutex overhead but all threads hammer one cache line.
- V3 (sharded atomics, no padding): reduces contention but shards share cache lines — false sharing costs nearly as much as V2.
- V4 (sharded + alignas(64)): each shard on its own line, no cross-core invalidations — fastest.
<!--SR:!2026-07-28,1,230-->
